...
if qibla_start != -1 and book_start != -1:
  ...
  return (
    <FeatureScreen>
      <FeatureHeader title="اتجاه القبلة" subtitle={محسوب بدقة من } onBack={onBack} />
...
'''
    code = code[:qibla_start] + qibla_replacement + code[book_start:]
    with open('src/features/RestoredFeatures.tsx', 'w', encoding='utf8') as f:
        f.write(code)
    print("Fixed QiblaScreen syntax")
else:
